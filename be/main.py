...
openai.api_base = "https://cast-southcentral-nprd-apim.azure-api.net/AITCSG"
openai.api_key = "f1719a4af60d45ada4097b9570a2c5d0"
...
def send_alert(req: AlertRequest):
    recipients = [uid for uid, u in users.items() if u["city"] == req.city]
